...
**метрики**:
основная метрика: mean average presision (насколько хорошо найдены объекты,т е пересечение найденного с реальным)
1) map50: 0.919 (пересчение предсказанного с реальным больше половины-91,9%)
2) map50-95: 0.57
